...
class VideoProtocol(Protocol):
    name = "video_stimulus_prestimulation"

    def __init__(self):
        super().__init__()

        # List all stimuli
        json_paths = r"assets/stim_videos/20230329_rings_prestimulation_shorter/"
    ...
    def get_stim_sequence(self):
        ...
        path = 'stim_videos/20230329_rings_prestimulation_shorter/' + video_name + '.mp4'
