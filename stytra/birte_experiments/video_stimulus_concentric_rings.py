...
class VideoProtocol(Protocol):
    ...
    def __init__(self):
        ...
        # List all stimuli
        json_paths = "/Users/zuidinga/PycharmProjects/stytra/stytra/birte_experiments/assets/stim_videos/20220809_concentric_rings/"
    ...
    def get_stim_sequence(self):
        ...
        path = 'stim_videos/20220809_concentric_rings/' + video_name + '.mp4'
