...
class VideoProtocol(Protocol):
    ...
    def __init__(self):
        ...
        # List all stimuli
        json_paths = r"C:/Users/zuidinga/PycharmProjects/stytra_birte/stytra/stytra/birte_experiments/assets/stim_videos/20220810_concentric_rings/"
    ...
    def get_stim_sequence(self):
        ...
        path = 'stim_videos/20220810_concentric_rings/' + video_name + '.mp4'
